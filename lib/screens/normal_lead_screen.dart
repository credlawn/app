...
import 'lead_status_update_screen.dart'; // Import the new screen
...
class _NormalLeadsScreenState extends State<NormalLeadsScreen> with WidgetsBindingObserver {
  late Future<List<CallingDataModel>> _normalLeads;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Normal Leads', style: GoogleFonts.poppins(color: Colors.white, fontSize: 20)),
              ...
              child: FutureBuilder<List<CallingDataModel>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(child: Text('No normal leads available.'));
                  } else {
