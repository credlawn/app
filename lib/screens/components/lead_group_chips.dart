              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    _buildLeadGroupChip('CNR', Colors.orange, FontAwesomeIcons.phoneSlash),
                    const SizedBox(width: 8),
                    _buildLeadGroupChip('Follow Up', Colors.blue, FontAwesomeIcons.calendarCheck),
                    const SizedBox(width: 8),
                    _buildLeadGroupChip('Login', Colors.indigo, FontAwesomeIcons.signInAlt),
                    const SizedBox(width: 8),
                    _buildLeadGroupChip('Failed', Colors.red.shade400, FontAwesomeIcons.timesCircle),
                    const SizedBox(width: 8),
                    _buildLeadGroupChip('Inactive', Colors.grey, FontAwesomeIcons.moon),
                    const SizedBox(width: 8),
                  ],
                ),
              ),
