...
class _CnrLeadsScreenState extends State<CnrLeadScreen> with WidgetsBindingObserver {
  late Future<List<CallingDataModel>> _cnrLeads;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('CNR Leads', style: GoogleFonts.poppins(color: Colors.white, fontSize: 20)),
